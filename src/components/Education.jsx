...
const EducationCard = ({ edu }) => {
  return (
    <div className="bg-[#0f2232] border border-sky-500/25 rounded-2xl shadow-md hover:shadow-lg transition-shadow p-12 md:p-14">
      <div className="flex items-start gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="mb-4">
            ...
            <p className="text-4xl text-sky-400 font-semibold mb-2">
              {edu.field}
            </p>
            ...
            <div className="flex flex-wrap gap-5 text-2xl text-slate-200">
          ...
          <div className="flex flex-wrap gap-3 mb-4">
            <div className="bg-green-500/10 text-green-200 px-5 py-3 rounded-xl border border-green-500/30 text-2xl font-medium">
          ...
          {edu.relevantCoursework?.length > 0 && (
            <div className="mb-4">
              <h4 className="flex items-center gap-2 font-semibold text-slate-100 mb-4 text-4xl">
              ...
              <div className="flex flex-wrap gap-2">
                {edu.relevantCoursework.map((course, index) => (
                  <span
                    key={index}
                    className="bg-slate-900 text-slate-300 px-4 py-2 rounded-full text-2xl"
                  >
                    {course}
                  </span>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                {edu.activities.map((activity, index) => (
                  <li key={index} className="text-slate-200 flex items-start gap-3 text-3xl">
    ...
    <section id="education" className="py-24 md:py-28 bg-[#0b1d2a]">
      <div className="max-w-none px-6 md:px-12 xl:px-16">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-200 max-w-5xl mx-auto text-4xl md:text-3xl">
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-8">
          <div className="bg-[#0f2232] border border-sky-500/25 rounded-2xl p-8 text-center">
            <GraduationCap className="text-sky-400 mx-auto mb-4" size={48} />
            <p className="text-6xl font-bold text-white">1</p>
            <p className="text-slate-200 text-4xl">Degree Program</p>
          </div>

          <div className="bg-[#0f2232] border border-sky-500/25 rounded-2xl p-8 text-center">
            <Award className="text-green-400 mx-auto mb-4" size={48} />
            <p className="text-5xl font-bold text-white">Ongoing</p>
            <p className="text-slate-200 text-4xl">Academic Status</p>
          </div>

          <div className="bg-[#0f2232] border border-sky-500/25 rounded-2xl p-8 text-center">
            <BookOpen className="text-purple-400 mx-auto mb-4" size={48} />
            <p className="text-6xl font-bold text-white">5+</p>
            <p className="text-slate-200 text-4xl">Core CS Subjects</p>
          </div>
        </div>
      </div>
    </section>
